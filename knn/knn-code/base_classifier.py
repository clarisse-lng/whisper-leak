...
class BaseClassifier(nn.Module):
    ...
    def save(self, filepath):
        ...
        if self.norm:
            ...
            with open(norm_filepath, 'w', encoding='utf-8') as f:  # ← uncomment this
                json.dump({
    ...
    def load(cls, filepath, device):
        ...
        if class_name == "LightGBMClassifier":
            ...
            classifier = RNNClassifier.load(filepath, device)
        else:
    ...
    def inference(self, input_data, device):
        ...
        # Handle a 2-tuple
            ...
            # Prepare tensor
            sample = np.stack([time_padded, size_padded], axis=1)
